...
<Navbar bg='transparent' expand='lg' variant='dark'>
  <Container fluid>
<Navbar.Brand href='' style={{color:'black'}}><img src={tv} style={{width:'50px'}} alt='tv'/>&nbsp;&nbsp;MovieBox</Navbar.Brand>
<Form className='d-flex form1' style={{color:'white', width:'50%'}} onSubmit={Search}>
   ...
   <Button style={{backgroundColor: 'transparent', border: 'none'}}>
    ...
    <Button type='sumbit' variant='secondary' onClick={Sign} style={{backgroundColor:'transparent', border:'none', color:'black'}}>Sign in<img src={menu} style={{width:'30px', backgroundColor:'red'}} alt='menu icon'/></Button>
  </Container>
</Navbar>
<div className='head-text'>
<img src={img} style={{width:'100%'}} alt='header'/>
<div className='center_text'>
<h3>John Wick 3: <br></br> Parabellum</h3>
<p></p>
<p><img src={imdb} style={{width:'30px'}} alt='imdb'/>&nbsp;&nbsp;8.6 &nbsp;&nbsp;&nbsp;&nbsp;
<img src={tomato} style={{width:'20px'}} alt='tomato'/>&nbsp;&nbsp;97%
</p>
...
<div className='label'>
  ...
  <div><button style={{color:'red', border:'none', backgroundColor:'transparent'}} type='submit'>See more<img src={chevronright} style={{width:'40px'}} alt='chevronright'/></button></div>
</div>
